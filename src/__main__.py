...
if __name__ == '__main__':
    ...
    TabletopEnv.min_foods = 80
    TabletopEnv.max_foods = 180
    # Range of how much food each food area has in it
    TabletopEnv.min_food_amt = 400
    TabletopEnv.max_food_amt = 700
    TabletopEnv.fps = 30
    ...
    Ant.home = np.array((screen_size//2, screen_size//2))
    ...
    breeding_method = Breeding.Induvidual
    ...
    mutation_method = Mutation.Induvidual(total_mutation_chance=0.8, mutation_chance=.05)

    # Setup
    generations = [Generation()]
    table = TabletopEnv(generations[-1], steps, screen_size, start_paused=False, show_events=False)
